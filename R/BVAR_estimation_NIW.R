BVAR_estimation_NIW = function(data, lags = 4, reps = 1000, burn = 500, const = T, trend = F, trend_qua = F, ex = NULL, ex_lag = NULL, xlags = 0, lamda = 1 ,tau = 4  , epsilon = 1) {
  ...
  vardata = vardata_form(data,lags = lags ,const = const, trend = trend, trend_qua = trend_qua, ex, ex_lag = ex_lag, xlags = xlags)
